...
function ListUserFiles($Thefile,$TheClass,$userID,$fl) {
	...
	global $post;
		...
		echo '<tr><td class="'.$TheClass.'" width="60%" ><img src="'. $tExt.'" width="20" > '.pathinfo($Thefile, PATHINFO_FILENAME) .'</td>';
     ...
     <div id="dNotes'.$fl.'" style="display:none;">'. $getDescr.'</div>
		...
		echo '<td class="'.$TheClass.'"><form method="post" action="'.$_SERVER['REQUEST_URI'].'"><input name="theDLfile" rel="download.png"  value="'.$userID.'/'.$Thefile.'" type="image" title="Download '.$Thefile.'" src="'.plugins_url( '/user-files/img/download.png' , dirname(__FILE__) ). '"   alt="" width="20" height="20" /> ';
		...
		echo '     |     <input type="image" name="deletefile" value="'.$userID.'/'.$Thefile.'" title="Delete '.$Thefile.'" src="'.plugins_url( '/user-files/img/delete.png ' , dirname(__FILE__) ). '" alt="" width="20" height="20" /></form> </td></tr>';
		}else{
		echo '</form></td></tr>';
...
echo '<form method="post" action="'.$_SERVER['REQUEST_URI'].'"><input name="theDLfile" rel="download.png" href="'.$_SERVER['REQUEST_URI'].'" value="'.$userNum.'/'.$files.'"  type="image" title="Download '.$files.'" src="'.plugins_url( '/user-files/img/download.png' , dirname(__FILE__) ). '"   alt="" width="20" height="20" /> ';
		...
		echo '     |     <input type="image" name="deletefile" value="'.$userNum.'/'.$files.'" title="Delete '.$files.'" src="'.plugins_url( '/user-files/img/delete.png ' , dirname(__FILE__) ). '" alt="" width="20" height="20" /></form> </td></tr>';
		}else{
		echo '</form></td></tr>';
...
echo '<input type="image" name="deletefile" value="'.$userNum.'/'.$files.'" title="Delete '.$files.'" src="'.plugins_url( '/user-files/img/delete.png ' , dirname(__FILE__) ). '" alt="" width="20" height="20" /></form>	';					
					  $tp++;
								}
							}
						echo '</td></tr>';
